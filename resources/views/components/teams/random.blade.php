...
<div class="flex flex-col">
    <div class="flex justify-center items-center p-2 h-6/10 bg-gray-300 dark:bg-gray-700 rounded-md">
    ...
    <div class="flex flex-col gap-x-2 mt-2">
        ...
        <p class="{{ $team['conference'] === 'East' ? 'bg-blue-700 dark:bg-blue-800' : 'bg-red-700 dark:bg-red-800' }} text-white w-fit rounded-sm px-1">
            {{ $team['abbreviation'] }}
        </p>
    </div>
